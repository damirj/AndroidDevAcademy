...
import hr.ferit.brunozoric.taskie.common.HIGH_PRIORITY
import hr.ferit.brunozoric.taskie.common.LOW_PRIORITY
import hr.ferit.brunozoric.taskie.common.MEDIUM_PRIORITY
...
class AddTaskFragmentDialog: DialogFragment() {
    ...
    private fun saveTask() {
        ...
        TaskPrefs.store(TaskPrefs.KEY_PRIORITY, priority.name)
        clearUi()
