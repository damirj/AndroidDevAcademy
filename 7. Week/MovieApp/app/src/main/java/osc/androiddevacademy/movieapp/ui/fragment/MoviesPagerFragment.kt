package osc.androiddevacademy.movieapp.ui.fragment
...
import osc.androiddevacademy.movieapp.ui.adapter.MoviePagerAdapter
...
class MoviesPagerFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        currentMovie = arguments?.getParcelable(PAGER_SELECTED_MOVIE_EXTRA)!!

        movieList.indexOfFirst { it == currentMovie }

        moviePager.adapter = pagerAdapter

        pagerAdapter.setMovies(movieList)

        moviePager.currentItem = movieList.indexOfFirst { it == currentMovie }
    }
